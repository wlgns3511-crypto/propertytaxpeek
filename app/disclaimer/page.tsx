...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Disclaimer and limitations of liability for PropertyTaxPeek.",
...
export default function DisclaimerPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        The information provided on PropertyTaxPeek is for general informational and educational purposes only. While we
      ...
      <p>
        Data displayed on PropertyTaxPeek is sourced from publicly available databases and third-party sources. While we
      ...
      <p>
        PropertyTaxPeek displays third-party advertisements through Google AdSense and other ad networks. These advertisements
        are provided by third parties and do not imply endorsement by PropertyTaxPeek. We are not responsible for the content
      ...
      <p>
        In no event shall PropertyTaxPeek, its owners, operators, or contributors be liable for any direct, indirect,
      ...
      <p>
        ...
        <a href="/contact" className="text-blue-700 hover:underline">Contact page</a>.
      </p>
    </article>
  );
}
