        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-blue-800">{stateA.effective_rate.toFixed(2)}%</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-600">Median Tax</span>
            ...
            <div className="flex justify-between">
              <span className="text-slate-600">Tax on $350K Home</span>
