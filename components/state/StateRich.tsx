...
export function StateRich({ slug, state: initialState }: Props) {
  ...
  return (
    <section className="mt-10 rounded-xl border border-slate-200 bg-white p-6">
      <h2 className="text-2xl font-bold text-slate-900">State Tax Context</h2>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <div className="rounded-lg border border-slate-200 p-4">
          <h3 className="text-sm font-semibold text-slate-900">Highest-Tax Counties</h3>
          <div className="mt-4 space-y-3">
            {counties.map((county) => (
              <div key={county.slug} className="rounded-lg bg-slate-50 p-3">
        ...
        <div className="rounded-lg border border-slate-200 p-4">
          <h3 className="text-sm font-semibold text-slate-900">Where The State Sits</h3>
          <div className="mt-4 space-y-3">
            <div className="rounded-lg bg-slate-50 p-3">
              <div className="font-medium text-slate-900">Median tax bill</div>
              <div className="text-xs text-slate-500">{fmtCurrency(state.median_tax)} on a {fmtCurrency(state.median_home_value)} home</div>
            </div>
            <div className="rounded-lg bg-slate-50 p-3">
              <div className="font-medium text-slate-900">National positioning</div>
              <div className="text-xs text-slate-500">
                {highState
        ...
        <div className="rounded-lg border border-slate-200 p-4">
          <h3 className="text-sm font-semibold text-slate-900">Edge States To Compare</h3>
          <div className="mt-4 space-y-3">
