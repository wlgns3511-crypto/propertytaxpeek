...
export function PropertyTaxCalculator({ defaultState, defaultRate, states = [] }: Props) {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-slate-50 border border-blue-200 rounded-xl p-6 my-8">
      <h3 className="text-lg font-bold text-blue-900 mb-4">Property Tax Calculator</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-300 focus:border-blue-400 outline-none"
            min={0}
            step={10000}
          />
        </div>
        ...
        {states.length > 0 ? (
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-300 focus:border-blue-400 outline-none bg-white"
            >
        ...
        <div>
          ...
          <div className="px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm font-semibold text-blue-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
        <div className="bg-white rounded-lg p-4 text-center border border-blue-100">
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1">Annual Tax</div>
          <div className="text-2xl font-bold text-blue-800">{fmt(annualTax)}</div>
        </div>
        <div className="bg-white rounded-lg p-4 text-center border border-blue-100">
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1">Monthly Tax</div>
          <div className="text-2xl font-bold text-blue-800">{fmt(monthlyTax)}</div>
        </div>
        <div className="bg-white rounded-lg p-4 text-center border border-blue-100">
          <div className="text-xs text-slate-500 uppercase tracking-wider mb-1">vs National Avg</div>
