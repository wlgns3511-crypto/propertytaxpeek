...
export function CompareRich({ slug, a, b }: Props) {
  ...
  return (
    <section className="mt-10 rounded-xl border border-stone-200 bg-white p-6">
      <h2 className="text-2xl font-bold text-stone-900">Property Tax Decision Framing</h2>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        <div className="rounded-lg border border-stone-200 bg-stone-50 p-4">
          <div className="text-xs font-medium uppercase tracking-wide text-stone-500">Lower Effective Rate</div>
          <div className="mt-2 text-lg font-semibold text-stone-900">{lowerRate.state}</div>
        ...
        <div className="rounded-lg border border-stone-200 bg-stone-50 p-4">
          <div className="text-xs font-medium uppercase tracking-wide text-stone-500">Lower Median Tax Bill</div>
          <div className="mt-2 text-lg font-semibold text-stone-900">{lowerMedianTax.state}</div>
          <p className="mt-2 text-sm text-stone-600">
            {lowerMedianTax.state} has the lower statewide median bill at {fmtCurrency(lowerMedianTax.median_tax)}.
          </p>
        </div>
        <div className="rounded-lg border border-stone-200 bg-stone-50 p-4">
          <div className="text-xs font-medium uppercase tracking-wide text-stone-500">Higher Home Value Baseline</div>
          <div className="mt-2 text-lg font-semibold text-stone-900">{higherHomeValue.state}</div>
          <p className="mt-2 text-sm text-stone-600">
      ...
      <div className="mt-6 rounded-lg border border-stone-200 p-4">
        <h3 className="text-sm font-semibold text-stone-900">How To Use This Compare</h3>
      ...
      <p className="mt-4 text-xs text-stone-500">Compare slug: {slug}</p>
    </section>
  );
}
