...
import { COUNTY_VINTAGE as DATA_VINTAGE } from "./authorship";
...
const PROFILE = {
  ...
  "entityLabel": "property-tax profile",
  "detailSegment": "blog",
  "source": "Census ACS and documented tax sources",
  "dataModule": "db",
  "dataFn": "getAllCounties"
} as {
